<template>
    <li>
        <button type="button"
            class="flex items-center w-full p-1 text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 hover:text-blue-500"
            :aria-controls="randomId" :data-collapse-toggle="randomId" @click="desplegado = !desplegado">
            <Icon :class="icon" />
